<template>
  <div class="contact-list-container">
    <button type="button" class="contact-list-trigger" @click="isOpen = !isOpen">
      Contacts ({{ chatStore.contacts.length }})
    </button>

    <div v-if="isOpen" class="contact-menu">
      ...
      >
        <div class="status-dot" :class="user.online ? 'online' : 'offline'"></div>
